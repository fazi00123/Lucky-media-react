    ...
    <section className="bg-black text-white px-[30px] sm:px-6 md:px-8 2xl:px-12 pt-[120px] pb-10 sm:py-20 md:py-24 mt-20 sm:mt-[150px] md:mt-[300px]">
      <div className=" grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 2xl:gap-20 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="font-[700] mt-4 text-[19px] leading-[34px] sm:text-[24px] sm:leading-[34px] md:text-[42px] md:leading-[72px] lg:text-[48px] lg:leading-[72px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 2xl:gap-12">
          ...
          <div className="bg-[#1a1a1a] 2xl:rounded-3xl rounded-2xl p-4 sm:p-6 2xl:p-7 text-center">
            ...
            <p className="text-[#D9D9D9] font-light text-base sm:text-xl md:text-2xl mt-2 leading-[32px] sm:leading-8 md:leading-9 2xl:leading-[45px]">
