...
<br /> <span className="text-[#00ff9c]">Cookies that we collect</span>
          </h1>
        </div>

        <div className="pt-10 sm:pt-16 items-center flex justify-center">
          <h2 className="text-center rounded-md px-5 py-4 text-[15px] md:text-[3vw] lg:text-[42px] font-bold leading-tight bg-[#00FF9C]">
            Allowing cookies helps us to improve!
          </h2>
        </div>
        ...
        <div className="text-center justify-center flex pt-6 pb-10">
          <a href="/Cookies-Policy.pdf" target="_blank" rel="noopener noreferrer">
