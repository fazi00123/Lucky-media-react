  ...
  return (
    <section id="contact" className="w-full py-16 bg-white text-center">
      ...
      <div className="text-center justify-center flex pt-6 sm:pt-8 lg:pt-14 px-4">
        <a href="">
        <button
          className="relative flex items-center justify-center rounded-lg border-[4px] border-black hover:border-transparent 
        ...
        >
          ...
          {/* Normal text */}
          <span
            className="transition-all text-lg md:text-[22px] lg:text-3xl 
          ...
          {/* Hover text */}
          <span
            className="absolute opacity-0 font-semibold text-lg md:text-[22px] lg:text-[26px] 
                       transition-all duration-500 group-hover:opacity-100 
                       group-hover:shadow-[0_0_20px_4px_rgba(0,255,170,0.9)] 
                       bg-white rounded-lg px-4 sm:px-6 md:px-8 py-2 sm:py-3 border-[4px] border-black whitespace-nowrap"
          >
            Fill out the brief
          </span>
        </button>
